...
<html lang="en">
<head>
<title>Packages And Hot Tours</title>
<!-- custom-theme -->
...
<!--[if lt IE 8]>
		...
		<![endif]-->
		<!--[if lt IE 9]>
		<script src="travel_agency/js/html5shiv.js"></script>
		<link rel="stylesheet" media="screen" href="travel_agency/css/ie.css">
		<![endif]-->
</head>
<body>
...
<!-- banner -->
					...
					<div class="header">
						<nav class="navbar navbar-default">
							<div class="navbar-header navbar-left">
								...
								<h1><a class="navbar-brand" href="index.jsp">Trip Planner</span></a></h1>
							</div>
								...
								<nav class="cl-effect-15" id="cl-effect-15">
									<ul class="nav navbar-nav">
										<li><a href="CustomerHome.jsp">Home</a></li>
													...
													<li class="active"><a href="CustomerPackage.jsp">Offers and Deals</a></li>
	...
	<div class="banner-bottom gallery">
		...
		<div class="wthree_head_section">
				<h2 class="w3l_header">Our <span>Holiday Packages</span></h2>
				<p>These are the packages we provide to the tourists with lots of interesting offers.</p>
			</div>
			<div class="w3ls_gallery_grids">
				<div class="col-md-4 w3_agile_gallery_grid">
					<div class="agile_gallery_grid">
					<!-- <a href="TripPlaces/london.jsp"> -->
					<div class="agile_gallery_grid1">
								<img src="images/g1.jpg" alt="" class="img-responsive"/>
								<center><h1><a href="TripPlaces/CustomerLondon.jsp">London</a></h1></center>
								<div class="w3layouts_gallery_grid1_pos">
							  		<h3>Get Exclusive offers</h3>
									<p> Open on new tab the package</p>
								</div>
					...
					<div class="agile_gallery_grid">
						<!-- <a href="images/g2.jpg"> -->
							<div class="agile_gallery_grid1">
								...
								<center><h1><a href="TripPlaces/CustomerSydney.jsp">Sydney</a></h1></center>
								<div class="w3layouts_gallery_grid1_pos">
							  		<h3>Get Exclusive offers</h3>
									<p> Open on new tab the package</p>
								</div>
					...
					<div class="agile_gallery_grid">
						<!-- <a title="Donec sapien massa, placerat ac sodales ac, feugiat quis est." href="images/g3.jpg"> -->
							<div class="agile_gallery_grid1">
								...
								<center><h1><a href="TripPlaces/CustomerMiami.jsp">Miami</a></h1></center>
								<div class="w3layouts_gallery_grid1_pos">
							  		<h3>Get Exclusive offers</h3>
									<p> Open on new tab the package</p>
								</div>
				...
				<div class="col-md-4 w3_agile_gallery_grid">
					<div class="agile_gallery_grid">
						<!-- <a title="Donec sapien massa, placerat ac sodales ac, feugiat quis est." href="images/g10.jpg"> -->
							<div class="agile_gallery_grid1">
								...
								<center><h1><a href="TripPlaces/CustomerSingapore.jsp">Singapore</a></h1></center>
								<div class="w3layouts_gallery_grid1_pos">
							  		<h3>Get Exclusive offers</h3>
									<p> Open on new tab the package</p>
								</div>
					...
					<div class="agile_gallery_grid">
						<a title="Mandarin Script" href="images/g12.jpg">
							<div class="agile_gallery_grid1">
								<img src="images/g12.jpg" alt=" " class="img-responsive" />
								<center><h1><a href="TripPlaces/CustomerChina.jsp">China</a></h1></center>
								<div class="w3layouts_gallery_grid1_pos">
							  		<h3>Get Exclusive offers</h3>
									<p> Open on new tab the package</p>
								</div>
					...
					<div class="agile_gallery_grid">
						<!-- <a title="Donec sapien massa, placerat ac sodales ac, feugiat quis est." href="images/g6.jpg"> -->
							<div class="agile_gallery_grid1">
								...
								<center><h1><a href="TripPlaces/CustomerNyc.jsp">NYC</a></h1></center>
								<div class="w3layouts_gallery_grid1_pos">
							  		<h3>Get Exclusive offers</h3>
									<p> Open on new tab the package</p>
								</div>
					...
					<div class="agile_gallery_grid">
						<!-- <a title="Donec sapien massa, placerat ac sodales ac, feugiat quis est." href="images/g7.jpg"> -->
							<div class="agile_gallery_grid1">
								...
								<center><h1><a href="TripPlaces/CustomerSahara.jsp">Sahara</a></h1></center>
								<div class="w3layouts_gallery_grid1_pos">
							  		<h3>Get Exclusive offers</h3>
									<p> Open on new tab the package</p>
								</div>
					...
					<div class="agile_gallery_grid">
						<!-- <a title="Donec sapien massa, placerat ac sodales ac, feugiat quis est." href="images/g8.jpg"> -->
							<div class="agile_gallery_grid1">
								...
								<center><h1><a href="TripPlaces/CustomerThailand.jsp">Thailand</a></h1></center>
								<div class="w3layouts_gallery_grid1_pos">
							  		<h3>Get Exclusive offers</h3>
									<p> Open on new tab the package</p>
								</div>
					...
					<div class="agile_gallery_grid">
						<!-- <a title="Donec sapien massa, placerat ac sodales ac, feugiat quis est." href="images/g9.jpg"> -->
							<div class="agile_gallery_grid1">
								...
								<center><h1><a href="TripPlaces/CustomerBangkok.jsp">Bangkok</a></h1></center>
								<div class="w3layouts_gallery_grid1_pos">
							  		<h3>Get Exclusive offers</h3>
									<p> Open on new tab the package</p>
								</div>
