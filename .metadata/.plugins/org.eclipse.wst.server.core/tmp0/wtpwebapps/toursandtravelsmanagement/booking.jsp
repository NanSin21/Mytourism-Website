									...
									<div class="fromtop">
										...
										<div class="agileinfo_main_grid">
											<div class="agileits_w3layouts_grid">
												<h5>Children*</h5>
												<select id="category1" name="category1" required="">
													<option value="category1">00</option>
													<option value="category2">01</option>
													<option value="category3">02</option>
													<option value="category4">03</option>
													<option value="category2">04</option>
													<option value="category3">05</option>
													<option value="category4">06</option>
												</select>
											</div>
										</div>
										<div class="clearfix"></div>
