...
<section class="contact-w3ls">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile2" data-aos="flip-left">
			<div class="contact-agileits">
				...
				<form action="ContactServlet" method="post">
                    ...
                    <div class="control-group form-group">
                        <div class="controls">
                            <label class="contact-p1">Feedback/Suggestions:</label>
                            <textarea id="subject" name="feedback" placeholder="Write something.." style="margin-top: 6px; margin-bottom:16px; height:170px; border-color: black; padding: 0.8em; width: 100%" ></textarea>
							<p class="help-block"></p>
						</div>
                    </div>
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong> +1234 567 890</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="nandu98sinha@gmail.com">nandu98sinha@gmail.com</a></p>
			<p class="contact-agile1"><strong>Address :</strong> JB Tower, Near SAL Hospital.</p>											
...
<!-- map -->
<div class="w3l-map">
	<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14685.290469936936!2d72.51505126718783!3d23.048630984939845!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395e84ac54a18239%3A0x558f4eb0ff0df853!2sMaxgen+Technologies+Pvt.Ltd!5e0!3m2!1sen!2sin!4v1532328905712" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
</div>
		...
		<div class="container">
			<div class="col-md-4 agile_footer_grid">
				...
				<ul class="w3_address">
					...
					<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="info@tripplanner.com">nandu98sinha@gmail.com</a></li>
