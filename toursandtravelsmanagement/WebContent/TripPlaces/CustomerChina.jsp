...
<title>China Trip Package</title>
<!-- <meta charset="utf-8"> -->
...
<div class="jumbotron" style="background-image: url('https://tripsinchina.files.wordpress.com/2013/04/cropped-china-242.jpg'); width: 100%;">
  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="panel panel-primary">
        ...
        <div class="panel-body"><img src="images/download.jpeg" class="img-responsive" style="width:100%" alt="Image"></div>
    ...
    <div class="col-sm-4"> 
      <div class="panel panel-primary">
        ...
        <div class="panel-body"><img src="images/download (1).jpeg" class="img-responsive" style="width:98%" alt="Image"></div>
    ...
    <div class="col-sm-4"> 
      <div class="panel panel-primary">
        ...
        <div class="panel-body"><img src="images/download (2).jpeg" class="img-responsive" style="width:95%" alt="Image"></div>
  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="panel panel-primary">
        ...
        <div class="panel-body"><img src="images/restaurant.jpeg" class="img-responsive" style="width:100%" alt="Image"></div>
    ...
    <div class="col-sm-4"> 
      <div class="panel panel-primary">
        ...
        <div class="panel-body"><img src="images/festival.jpeg" class="img-responsive" style="width:90%" alt="Image"></div>
    ...
    <div class="col-sm-4"> 
      <div class="panel panel-primary">
        ...
        <div class="panel-body"><img src="images/resort.jpeg" class="img-responsive" style="width:100%" alt="Image"></div>
