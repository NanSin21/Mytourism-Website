				...
				<ul class="rslides" id="slider3">
					<li>
						<div class="banner-text">
							...
							<p>Located in Ahmedabad, Gujarat.</p>
			...
			<div class="col-md-6 w3_two_grid_right">
				<div class="w3_two_grid_right1">
					...
					<div class="col-xs-9 w3_two_grid_right_gridr">
						<h4>Accommodation</h4>
						<p>You can stay, even with family or friends, in luxurious hotels or resorts.</p>
					</div>
					<div class="clearfix"> </div>
				</div>
				<div class="w3_two_grid_right1">
					...
					<div class="col-xs-9 w3_two_grid_right_gridr">
						...
						<p>We provide the best and efficiently used transports.</p>
					</div>
					<div class="clearfix"> </div>
				</div>
				<div class="w3_two_grid_right1">
					...
					<div class="col-xs-9 w3_two_grid_right_gridr">
						...
						<p>These agents are experienced and authorized who give you the best offers to suit your plans.</p>
					</div>
					<div class="clearfix"> </div>
				</div>
			</div>
			<div class="col-md-6 w3_two_grid_right">
				<div class="w3_two_grid_right1">
					...
					<div class="col-xs-9 w3_two_grid_right_gridr">
						...
						<p>We make your trip to visit the famous places and your planed places according to your time of stay.</p>
					</div>
					<div class="clearfix"> </div>
				</div>
				<!-- <div class="w3_two_grid_right1">
...
<div class="banner-bottom mid-section-agileits">
	...
	<div class="col-md-5 bannerbottomright">
		...
		<p>Experience the services we provide, to know how efficient and reliable we are.</p>
					...
					<ul class="slides">
						<li>
							<img src="images/c1.jpg" alt="" />
								<p>I enjoyed my vacations with my friends and all because of a planned manner of trip prepared by Trip Planner.</p>
								<div class="client">
									<h5>Gerald Roy</h5>
								</div>
						</li>
						<li>
							<img src="images/c2.jpg" alt="" />
								<p>My experience with Trip Planner was awesome and I look forward to be its customer in future again.</p>
								<div class="client">
									<h5>Adam Brandom</h5>
								</div>
						</li>
						<li>
							<img src="images/c3.jpg" alt="" />
								<p>I could visit every desired tourist spot within a few days of my holidays and it was all possible with the help of this travel agency.</p>
								<div class="client">
									<h5>Steve Artur</h5>
								</div>
						</li>
						<li>
							<img src="images/c4.jpg" alt="" />
								<p>My friends recommended me this travel agency for a business trip and I'm glad I chose this, which is why my tour was successful.</p>
								<div class="client">
									<h5>Martin Victor</h5>
								</div>
						</li>
