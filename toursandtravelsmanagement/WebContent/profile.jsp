...
<!-- main-section -->
	...
	<div class="wthree_head_section">
				<h3 class="w3l_header">Your <span>Profile</span></h3>
			</div>
		...
		<table id="customers" style="width:100%" >
			...
			<tr>
				<td colspan="3" align="center" id="h"><h1>
						Welcome , <b><%=ct.getFirstname()%> <%=ct.getLastname()%></b>
					</h1></td>
			</tr>
			...
			<tr>
				...
				<td><h5>:</h5></td>
				<td align="center"><h5><%=ct.getFirstname()%></h5></td>
			</tr>
			<tr>
				<td align="center"><h5>Last Name</h5></td>
				<td><h5>:</h5></td>
				<td align="center"><h5><%=ct.getLastname()%></h5></td>
			</tr>
			<tr>
				<td align="center"><h5>Email Id</h5></td>
				<td><h5>:</h5></td>
				<td align="center"><h5><%=ct.getEmail()%></h5></td>
			</tr>
			<tr>
				<td align="center"><h5>Gender</h5></td>
				<td><h5>:</h5></td>
				<td align="center"><h5><%=ct.getGender()%></h5></td>
			</tr>
			<tr>
				<td align="center"><h5>Date of Birth</h5></td>
				<td><h5>:</h5></td>
				<td align="center"><h5><%=ct.getDob()%></h5></td>
			</tr>
			
			<tr>
				<td align="center"><h5>Mobile No</h5></td>
				<td><h5>:</h5></td>
				<td align="center"><h5><%=ct.getMb_no()%></h5></td>
			</tr>
			<tr>
				<td align="center"><h5>Password</h5></td>
				<td><h5>:</h5></td>
				<td align="center"><h5><%=ct.getPassword()%></h5></td>
			</tr>
			<tr>
				<!-- <td></td> -->
				<td colspan="2" align="left"><a href="bookingprofile.jsp?id=<%= ct.getCust_id() %>"><span>Booking Details</span></a></td>
				<td align="right"><a id="a1" href="EditProfile2.jsp?cust_id=<%=ct.getCust_id()%>"><span>Edit Profile</span></a></td>
			</tr>
