...
<!-- main-section -->
	...
	<h3 class="w3l_header">Book Your Hotel</h3>
	<form action="hbookservlet" method="post">
									<div class="w3_agileits_main_grid w3l_main_grid">
										<div class="agileits_grid">
											<h5>Hotel Name * </h5>
											<div class="name">
												<input type="text" name="hotel_name" placeholder="Give a hotel's name " required>
											</div>
											<div class="clear"></div>
										</div>
									</div>
									<div class="w3_agileits_main_grid w3l_main_grid">
										<div class="agileits_grid">
											<h5>City * </h5>
												<input type="text" name="city" placeholder="Give a city name" required>
										</div>
										<div class="clear"></div>
									</div>
									...
									<div class="agileits_main_grid w3_agileits_main_grid held">
											<div class="wthree_grid">
												<h5>Hotel Type</h5>
												<select id="category" name="hotel type" >
													<option value="1 Star">One Star</option>
													<option value="2 Stars">Two Star</option>
													<option value="3 Stars">Three Star</option>
													<option value="4 Stars">Four Star</option>
													<option value="5 Stars">Five Star</option>
										...
										<div class="agileinfo_main_grid">
											<div class="agileits_w3layouts_grid">
												...
												<input name="no of rooms" type="text" size="10">
											</div>
										</div>
									<div class="fromtop">
										...
										<div class="agileits_main_grid w3_agileits_main_grid held">
											<div class="wthree_grid">
												<h5>Room Type</h5>
												<select id="category" name="room type" placeholder="eg: connecting rooms">
	...
	<!-- <div class="wthree_head_section">
				<h3 class="w3l_header">Book Your Train</h3>
			</div>
		<div class="login w3">
			<div class="sap_tabs">
							...
							<div class="login-top agileinfo">
								<h2></h2> -->
									...
									<div class="agileinfo_main_grid">
											<div class="agileits_w3layouts_grid">
												<h5>Travel Class*</h5>
												<select id="category2" name="t_class" required="">
							...
							<div class="login-top agileits">
								...
								<div class="w3layouts-agileits">
											...
											<div class="w3layoutscontactagileits">
												<form action="tbookservlet" method="post">
													<div class="w3_agileits_main_grid w3l_main_grid">
														<div class="agileits_grid">
															<h5>Name * </h5>
															<div class="name">
