...
<!-- main-section -->
	...
	<div class="wthree_head_section">
				<h3 class="w3l_header">Register Yourself</h3>
			</div>
		<div class="login w3">
								...
								<h2></h2>
									...
									<div class="fromtop">
										...
										<div class="agileinfo_main_grid">
											<div class="agileits_w3layouts_grid">
												<h5>Mobile Number</h5>
												<input type="tel" name="mb_no" maxlength="10" style="width: 100%; box-sizing: border-box; padding: 11px">
											</div>
										</div>
										<div class="clearfix"></div>
									</div>
										...
										<div class="agileits_main_grid w3_agileits_main_grid held">
											<div class="wthree_grid">
												<h5>Date Of Birth*</h5>
												<input type="date" style="width: 100%; padding: 5px" name="dob" value="Date" onfocus="this.value = '';" onblur="if (this.value=='') {this.value ='08/13/2016'}" required="">
											</div>
										</div>
